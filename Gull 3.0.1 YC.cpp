...
__forceinline uint64 BMagicAttacks(int i, uint64 occ) {
    uint64 att = 0;
...
#ifndef W32_BUILD
		fprintf(stdout,"id name Gull 3.0.1 x64\n");
#else
		fprintf(stdout,"id name Gull 3.0.1\n");
#endif
...
#ifndef W32_BUILD
	fprintf(stdout, "Gull 3.0.1 YC x64\n");
#else
	fprintf(stdout, "Gull 3.0.1 YC x32\n");
#endif
